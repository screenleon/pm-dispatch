...
| `snapshot_file` | no | Absolute path to a snapshot generated by `scripts/pm-prep-snapshot.sh`; if present, PM ingests it as ground truth before consuming brief metadata. |

...
| CC-368 | ✅ closed 2026-06-13 | **[Windows portability remediation bundle]** 六項 MSYS/Git-Bash on NTFS 假失敗/真限制一次性修補（CRLF strip、0700 SKIP-with-reason、partition canonical path、symlink SKIP、--auto-pack 正規化、jq 邊界 MSYS 路徑轉換 + stdin 輸入）。POSIX no-op，不動已出貨 Unix key。**See**: pr:#273 | ops/portability | 2026-06-13 | — | P2 | hygiene |

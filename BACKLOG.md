...
| CC-324 | 🔵 active | **[schema: dispatch brief 新增 conceptual_map + architecture_impact 欄位]** brief schema 加 `architecture_impact: none\|minor\|major` + `conceptual_map`（`major` 時必填）；conceptual_map 優先給 architecture-reviewer 用，而非直接掃 source diff。連結 CC-323 / CC-325 / CC-326。 | schema | 2026-06-05 | — | P2 | design |

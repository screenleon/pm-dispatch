...
**Done**: CHANGELOG.md [0.2.0] written; MILESTONES.md v0.2.0 updated; docs/GETTING_STARTED.md §4 updated with `doctor.sh` verification; docs/platform-support.md "Verify the install" section added; BACKLOG CC-058 flipped to ✅ closed.

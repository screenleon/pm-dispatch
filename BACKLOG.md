...
| CC-060 | ⏸ deferred | Extract codex-dispatch hardcoded params (timeout + model alias SoT) behind config layer; adds `~/.pm-dispatch/config` user-config precedent | arch/config | 2026-05-18 | CC-047 | — | — |

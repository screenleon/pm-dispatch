...
| CC-489 | 🔵 active | `scripts/` domain ownership 重整：Phase 0–2 已鎖住 inventory、module ABI 與 host resolver；後續以 OpenCode pilot → Codex → Claude 三個獨立 host migration phase 驗證 manifest、shim 與 side-effect parity，再收斂 shared runtime/ops/test domains | arch | 2026-07-14 | feedback:2026-07-16 | P2 | design |

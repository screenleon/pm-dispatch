...
## CC-222 — v0.2.0 release prep ⚠️ 2026-05-22

**Done**: CHANGELOG.md [0.2.0] written; MILESTONES.md v0.2.0 updated, v0.3.0 stub added; docs/GETTING_STARTED.md §4 updated with `doctor.sh` verification; docs/platform-support.md "Verify the install" section added; BACKLOG CC-058 flipped to ✅ closed.

**Remaining** (post-merge):
- `git tag v0.2.0 -m "v0.2.0 — Cross-platform ops"`
- `git push origin v0.2.0`
- GitHub Release with CHANGELOG.md [0.2.0] content as release notes body

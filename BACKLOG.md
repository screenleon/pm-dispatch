...
**See**: DECISIONS.md 2026-06-15 dispatch-model-B-primary-codex-write-guard-cli-only、[[CC-374]]（地基：write_guard_mode manifest 化）、[[CC-383]]（claude 已此模型）、[[CC-366]]（auto-pack）、umbrella [[CC-333]]。pr:#NNN

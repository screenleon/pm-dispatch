...
| CC-489 | 🔵 active | `scripts/` domain ownership重整：Phase 0–4 已完成 inventory、module ABI、host resolver、OpenCode pilot 與 Codex host migration；下一階段為 Claude host migration，最後才是 shared runtime/ops/test domains 與 shim retirement | arch | 2026-07-14 | feedback:2026-07-16 | P2 | design |

...
| 票 | 摘要 | 狀態 |
|----|------|------|
| CC-426 | `/pre-release v0.7.0` 三層審查工具：Layer 1 結構檢查（ticket body 有無待辦、PR# 覆蓋、CHANGELOG range）；Layer 2 語義比對（diff 是否滿足 ticket requirement）；Layer 3 盲點聲明。輸出報告非 GO/NO-GO。相依 [[CC-404]] + [[CC-403]] | ✅ pr:#TBD |

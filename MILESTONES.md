...
| 票 | 摘要 | 狀態 |
|----|------|------|
| CC-447 | offline clean install + latest released tag→v0.11 RC N-1 upgrade；foreign config/memory/user data 不變。屬正式 release evidence，若 release surface 改變即重跑 | ✅ pr:#573 |

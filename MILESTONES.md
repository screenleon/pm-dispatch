...
> CC-425（gate 解除 PR 綁定）暫不排入——需重構 gate result key schema，範圍比 CC-276/423 大一截，待本 Phase 完成後視情況併入或延後 v0.9.0。CC-433 排入 Phase 2 作為 CC-423 的後續收斂項，非阻塞本 Phase 其餘票的完成。CC-432 為 CC-423 pr-gate 迭代中發現並記錄的衍生票，同樣併入 Phase 2。

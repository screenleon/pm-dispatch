...
should_run "pre-release: Layer 2 uses patch for diff content" && assert_file_contains "pre-release: Layer 2 uses patch for diff content" "$PRE_RELEASE" "--patch" && pass "pre-release: Layer 2 uses patch for diff content"

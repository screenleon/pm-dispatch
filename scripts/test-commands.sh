...
should_run "pre-release: Layer 2 fetches file list before diff" && assert_file_contains "pre-release: Layer 2 fetches file list before diff" "$PRE_RELEASE" "gh pr view" && pass "pre-release: Layer 2 fetches file list before diff"
should_run "pre-release: Layer 2 uses json files query for file list" && assert_file_contains "pre-release: Layer 2 uses json files query for file list" "$PRE_RELEASE" "--json files" && pass "pre-release: Layer 2 uses json files query for file list"

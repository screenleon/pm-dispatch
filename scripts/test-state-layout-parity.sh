...
STATE_WRITER="$REPO_ROOT/scripts/lib/state-writer.sh"
...
make_writer_store() {
  ...
  PM_DISPATCH_STATE_ROOT="$store" _SW_REPO_ROOT="$repo" events_append \
    '{"schema_version":2,"id":"evt-20260101T000000Z-abcdef","kind":"run.completed","subject_type":"run","subject_id":"run-20260101T000000Z-abcdef","ts":"2026-01-01T00:00:00Z","payload":{"run_id":"run-20260101T000000Z-abcdef","state":"ok","from_state":"verifying","to_state":"ok"}}'
}

<!-- pm-schema: v1 -->
# fixture-bad-changelog-drift-active-ref backlog

## Index

| #  | Status | 主題 | 影響面 | 首次記錄 | Refs |
|----|--------|------|--------|----------|------|
| GX-001 | 🔵 active | 匯出資料改善 | backend | 2026-04-02 | pr:#99 |
...
**Requirement**: Exports include enough context for backend audits.

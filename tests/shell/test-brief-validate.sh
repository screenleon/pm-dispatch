#!/usr/bin/env bash
# Regression tests for runtime/bin/brief-validate.sh.
...
VALIDATOR="$REPO_ROOT/runtime/bin/brief-validate.sh"
...
files:
  ...
  - read: tests/shell/test-portable.sh
acceptance:
...
self_verify:
  - cmd: "bash tests/shell/test-brief-validate.sh"
...
files:
  - new: runtime/bin/brief-validate.sh
acceptance:
  - validator added
self_verify:
  - cmd: "bash runtime/bin/brief-validate.sh --help"
...
files:
  - write: docs/dispatch-brief.md
self_verify:
  - bash tests/shell/test-brief-validate.sh
EOF
...
files:
  - write: runtime/bin/brief-validate.sh
architecture_impact: minor
acceptance:
  - brief-validate.sh rejects invalid architecture_impact enum values
self_verify:
  - cmd: "grep -q 'architecture_impact' runtime/bin/brief-validate.sh"

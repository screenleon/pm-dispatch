...
pmctl_fixture_copy_spine() {
  ...
  cp "$source_root/runtime/lib/runner-kind.sh" "$target_root/runtime/lib/runner-kind.sh"
  cp "$source_root/runtime/lib/adapter-manifest.sh" "$target_root/runtime/lib/adapter-manifest.sh"
